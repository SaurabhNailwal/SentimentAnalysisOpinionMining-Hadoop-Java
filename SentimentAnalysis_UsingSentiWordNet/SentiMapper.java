...
public class SentiMapper extends MapReduceBase implements
	...
	public void map(LongWritable key, Text value,
		...
		text = removeStopWords(value.toString());

		count++;

		output.collect(new IntWritable(count), new Text(text));
	}
	...
	public static String removeStopWords(String text) {
		...
		// remove special characters -cannot remove _
		text = text
				.replaceAll(
						"\\'|\"|[()]|\\/|\\[|\\]|\\#|\\$|\\*|\\=|\\`|\\>|\\<|\\?|\\&|\\@|\\+|\\|\\%|\\^|\\+",
						"");

		// remove punctuations - cannot remove -
